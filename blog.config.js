...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || 'Zeena是一个游戏开发者、设计师、Unity游戏开发者/六边形战士/游戏教练/人工智能研究员', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://zeena-z-blog.vercel.app/about', // 网站地址
